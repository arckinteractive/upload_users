...
$english = array(
	...
	'upload_users:upload_help' => '<p>Choose a CSV file and upload it to create new user accounts. </p>
<p>The first row in the file must include information what the columns include. Required fields are username, name, email. If password field is not in the file a new random password will be generated. If you wish you can send the account information automatically to the user. </p>
<p>You can add any number of fields. All the other fields will be added as metadata for the user. If your delimiter is something else than a comma (,) a value can be a comma separates list of tags</p>
<p>Here is an example of a csv file:</p>',

	/**
	 * Error messages
	 */
	'upload_users:error:cannot_open_file' => 'Error opening file',
